  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <div className="relative overflow-hidden bg-white pb-16 pt-24 sm:pb-24 sm:pt-32">
        <div
          className="absolute left-1/2 top-0 -translate-x-1/2 overflow-hidden blur-3xl"
          aria-hidden="true"
        >
        ...
        <div className="container relative mx-auto px-4 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg font-medium leading-8 text-slate-600">
            Emergency blood donation network connecting donors with those in
            need. Real-time availability and verified donor profiles.
          </p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            <a
              href="#search"
              className="text-sm font-black uppercase tracking-widest text-slate-500 hover:text-red-600 transition-colors"
            >
              Find Donors ↓
            </a>
          </div>
      ...
      <div
        id="search"
        className="container mx-auto mt-12 px-4 pb-24 relative z-10"
      >
          ...
          <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between px-2">
            <div>
              ...
              <p className="text-sm font-bold text-slate-400">
                Search results based on your selection
              </p>
            </div>
        ...
        <div className="mt-12 overflow-hidden rounded-[40px] bg-slate-900 p-12 text-center text-white relative">
          ...
          <p className="mx-auto mt-4 max-w-lg font-medium text-slate-400">
            Your single donation can save up to three lives. Join our verified
            network of active donors in your local area.
          </p>
          <Button
            variant="outline"
            onClick={() => setIsRegistering(true)}
