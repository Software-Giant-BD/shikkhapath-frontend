    ...
    <div className="min-h-screen bg-[#FDFDFF]">
      ...
      <div className="relative overflow-hidden bg-white py-24 sm:py-32">
        <div className="absolute left-1/2 top-0 -z-10 -translate-x-1/2 overflow-hidden blur-3xl" aria-hidden="true">
          <div className="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-[#f6ad55] to-[#ed8936] opacity-10" />
        </div>
        ...
        <div className="container relative mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl font-black tracking-tighter text-slate-800 sm:text-7xl uppercase italic leading-none">
            Fire Station <span className="text-orange-600">Directory</span>
          </h1>
          <p className="mx-auto mt-8 max-w-2xl text-lg font-bold leading-8 text-slate-400 uppercase tracking-widest">
            Speed is Life. Access and contact any fire station in 
            Bangladesh instantly for emergency assistance.
          </p>
          <div className="mt-12 flex items-center justify-center gap-6">
            <a href="#search" className="rounded-2xl bg-orange-600 px-8 py-4 text-xs font-black uppercase tracking-widest text-white shadow-xl shadow-orange-500/20 transition-all hover:bg-orange-700 hover:scale-105 active:scale-95">
              Access Directory
            </a>
            <button className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-slate-400 hover:text-orange-600 transition-colors">
      ...
      <div className="container mx-auto mt-4 px-4">
        <ServiceAdBanner label="[ Fire Station Directory Sponsor ]" />
      </div>

      {/* Main Content */}
      <div id="search" className="container mx-auto mt-12 px-4 pb-32 relative z-10">
        <div className="rounded-[56px] bg-white p-10 shadow-[0_32px_120px_-20px_rgba(237,137,54,0.08)] border border-white">
          <div className="mb-12 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between px-4">
            <div className="space-y-1">
              <h2 className="text-3xl font-black text-slate-800 uppercase italic">Station <span className="text-orange-600">Archive</span></h2>
            ...
            <div className="flex h-12 items-center gap-3 rounded-2xl bg-orange-50 px-6 text-[10px] font-black uppercase tracking-widest text-orange-600 ring-1 ring-orange-100">
        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-3">
          <div className="flex flex-col items-center justify-center rounded-[40px] border border-slate-100 bg-white p-10 text-center transition-all hover:bg-white/50">
            <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-50 text-orange-600">
