    ...
    <div className="flex flex-col gap-6">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div className="relative">
          <ShieldCheck className="absolute left-4 top-1/2 z-10 h-4 w-4 -translate-y-1/2 text-orange-600" />
          <SearchableSelect
            options={[
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-[20px] border border-slate-200 bg-white py-4 pl-12 pr-6 text-[13px] font-black uppercase tracking-widest text-slate-700 outline-none transition-all placeholder:text-slate-300 focus:border-orange-600"
          />
        </div>
