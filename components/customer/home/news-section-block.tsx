...
export function NewsSectionBlock({ title, href, featured, sideItems, compact = false }: Props) {
  return (
          ...
          <Link href={href} className="block">
            <div className="relative overflow-hidden">
              <Image
                ...
                width={600}
                height={380}
                className={`w-full object-cover transition-transform duration-300 group-hover:scale-[1.02] ${compact ? "aspect-video" : "aspect-video"}`}
              />
