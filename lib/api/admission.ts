  ...
  try {
    ...
    const mockData: AdmissionUniversityModel[] = [
      ...
      },
      {
        ...
        app_start_date: "2026-01-10",
        app_deadline: "2026-02-12",
        exam_type: "MCQ",
        seats: 4926,
        tags: ["Public"],
        req_ssc: 3.5,
        ...
        req_total: 7.5,
        allowed_groups: ["Science", "Commerce", "Arts"],
        apply_url: "https://admission.cu.ac.bd",
      },
      {
        id: "ru",
      ...
      },
      {
        ...
        app_start_date: "2026-02-20",
        app_deadline: "2026-03-20",
        exam_type: "MCQ",
        seats: 1700,
        tags: ["Science & Tech", "Cluster"],
        req_ssc: 3.5,
        req_hsc: 3.5,
        req_total: 8.0,
        allowed_groups: ["Science", "Commerce", "Arts"],
        apply_url: "https://gstadmission.ac.bd",
      },
      {
        id: "ku",
      ...
      },
      {
        ...
        unit: "Undergraduate (Honours)",
        exam_date: "2026-05-10",
        app_start_date: "2026-04-01",
        ...
        req_total: 6.0,
        allowed_groups: ["Science", "Commerce", "Arts"],
        apply_url: "https://app1.nu.edu.bd",
      },
      {
        id: "bou",
        ...
        app_start_date: "2026-03-01",
        app_deadline: "2026-04-15",
        exam_type: "Written & MCQ",
        seats: "Unlimited",
        ...
        req_total: 4.0,
        allowed_groups: ["Science", "Commerce", "Arts"],
        apply_url: "https://osapsnew.bou.ac.bd",
      },
      {
        id: "bsmmu",
        ...
        app_start_date: "2026-03-10",
        app_deadline: "2026-04-10",
        exam_type: "MCQ",
        seats: 500,
        tags: ["Medical", "Public"],
        req_ssc: 4.0,
      ...
      },
      {
        ...
        app_start_date: "2026-01-11",
        app_deadline: "2026-01-23",
        exam_type: "MCQ",
        seats: "Central DGME",
        tags: ["Medical", "Public"],
        req_ssc: 4.0,
        ...
        req_total: 9.0,
        allowed_groups: ["Science"],
        apply_url: "https://dgme.teletalk.com.bd",
      },
      {
        id: "dmc",
      ...
      },
      {
        ...
        app_start_date: "2026-03-20",
        app_deadline: "2026-04-25",
        exam_type: "Written",
        seats: 1235,
        tags: ["Engineering"],
        req_ssc: 4.0,
        ...
        req_total: 9.0,
        allowed_groups: ["Science"],
        apply_url: "https://www.ruet.ac.bd",
      },
      {
        id: "cuet",
        ...
        req_total: 9.0,
        allowed_groups: ["Science"],
        apply_url: "https://www.cuet.ac.bd",
      },
      {
        id: "kuet",
        ...
        req_total: 9.0,
        allowed_groups: ["Science"],
        apply_url: "https://www.kuet.ac.bd",
      },
      {
        id: "just",
      ...
      },
      {
        ...
        unit: "Agriculture Cluster",
        exam_date: "2026-05-25",
        app_start_date: "2026-04-10",
        app_deadline: "2026-05-10",
        exam_type: "MCQ",
        seats: 1116,
        tags: ["Agriculture"],
        req_ssc: 3.5,
        ...
        req_total: 8.0,
        allowed_groups: ["Science"],
        apply_url: "https://acas.edu.bd",
      },
      {
        id: "sau",
        name: "Sher-e-Bangla Agricultural University (SAU)",
        unit: "Agriculture Cluster",
        exam_date: "2026-05-25",
        app_start_date: "2026-04-10",
        app_deadline: "2026-05-10",
      ...
      },
      {
        ...
        req_total: 9.0,
        allowed_groups: ["Science"],
        apply_url: "https://www.duet.ac.bd",
      },
      {
        id: "mbstu",
      ...
      {
        id: "cvasu",
        name: "Chittagong Veterinary and Animal Sciences University (CVASU)",
        unit: "Agriculture Cluster",
        exam_date: "2026-05-25",
        app_start_date: "2026-04-10",
        app_deadline: "2026-05-10",
      ...
      {
        id: "kau",
        name: "Khulna Agricultural University (KAU)",
        unit: "Agriculture Cluster",
        exam_date: "2026-05-25",
        app_start_date: "2026-04-10",
        app_deadline: "2026-05-10",
