...
export async function getUniversityEvents(
  ...
  const url = query
    ? `/api/university-events?${query}`
    : `/api/university-events`;
    ...
    let mockData: UniversityEventModel[] = [
      {
        ...
        description:
          "An orientation program for incoming admission candidates detailing the process, seating plans, and general guidelines.",
      ...
      },
      {
        ...
        description:
          "The largest engineering competition including competitive programming, line follower robots, and hackathons.",
        type: "Competition",
      ...
      },
      {
        ...
        description:
          "Important directives for candidates taking the A-Unit examinations. Learn about OMR checking and time management.",
        type: "Webinar",
      ...
      },
      {
        ...
        description:
          "Explore opportunities for full-ride scholarships in North America and Europe. Open for all 3rd and 4th year students.",
        type: "Seminar",
      ...
      },
      {
        ...
        description:
          "A free crash course covering essential biology topics for the upcoming national medical admission exam.",
        type: "Workshop",
